...
import 'schema/parking_spaces_record.dart';
...
export 'schema/parking_spaces_record.dart';
...
/// Functions to query ParkingSpacesRecords (as a Stream and as a Future).
Future<int> queryParkingSpacesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ParkingSpacesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ParkingSpacesRecord>> queryParkingSpacesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<ParkingSpacesRecord>> queryParkingSpacesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ParkingSpacesRecord>> queryParkingSpacesRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
