                  ...
                  child: FutureBuilder<List<ParkingSpacesRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<ParkingSpacesRecord>
                          listViewParkingSpacesRecordList = snapshot.data!;
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, listViewIndex) {
                          final listViewParkingSpacesRecord =
                              listViewParkingSpacesRecordList[listViewIndex];
                          return Padding(
                                    ...
                                    Container(
                                      ...
                                      child: Padding(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Image.network(
                                            listViewParkingSpacesRecord.imgUrl!,
                                            width: 44.0,
                                            height: 44.0,
                                            fit: BoxFit.cover,
                                          ),
                                                    ...
                                                    onPressed: () async {
                                                      var confirmDialogResponse =
                                                          await showDialog<
                                                                ...
                                                                builder:
                                                                  ...
                                                                  return AlertDialog(
                                                                    title: Text(
                                                                        'Caution!'),
                                                                    content: Text(
                                                                        'Are you sure you want to delete the space! This can not be undone!'),
                                                                    actions: [
                                                                      TextButton(
                                                              ...
                                                              false;
                                                      await listViewParkingSpacesRecord
                                                          .reference
                                                          .delete();
                                                    },
                                                    text: 'Delete Space',
